 ...
 * @author Usuário
 */
public class ConsultClipBoard extends JPanel {
    
    public ConsultClipBoard() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${pessoa}"));
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                ConsultClipBoard.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                ConsultClipBoard.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                ConsultClipBoard.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                ConsultClipBoard.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultClipBoard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
